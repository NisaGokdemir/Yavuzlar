<?php
    ...
    $company = getCompanyByRestaurantId($id);

    if (!$company) {
        header("Location: restaurant.php?message=Firma bulunamadı!");
        exit();
    }
?>
...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <div class="card mb-4" style="width: 18rem;">
            <img src="<?php echo $restaurant['image_path']; ?>" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Restoran Bilgileri</h5>
                <p>Restoran Ad: <?php echo $restaurant['name']; ?></p>
                <p>Açıklama: <?php echo $restaurant['description']; ?></p>
            </div>
        </div>
        ...
        <a href="restaurant.php" class="btn btn-primary mt-3">Geri Dön</a>
    </div>
