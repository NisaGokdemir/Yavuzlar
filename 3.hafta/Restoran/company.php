...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <h5 class="title mb-4 mt-5">Firmalar</h5>
        <form method="POST" action="">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="name" placeholder="Firma ismi girin" required>
        ...
        <?php foreach ($result as $company): ?>
            <div class="input-group mb-3">
                ...
                <a href="infoCompany.php?id=<?php echo $company['id']; ?>" class="btn btn-outline-secondary">Görüntüle</a>
                <a href="updateCompany.php?id=<?php echo $company['id']; ?>" class="btn btn-outline-secondary">Güncelle</a>
                <a href="deleteCompany.php?id=<?php echo $company['id']; ?>" class="btn btn-outline-secondary">Sil</a>
            </div>
        <?php endforeach; ?>

        <form action="addCompany.php" method="POST" enctype="multipart/form-data">  
            <h5 class="title mb-4 mt-5">Firma Ekle</h5>
            <div class="mb-3">  
            ...
            <div class="mb-3">  
                ...
                <textarea class="form-control" id="companyDesc" name="companyDesc" rows="3" required></textarea>  
            </div>  
            <div class="mb-3">  
                <label for="companyLogo" class="form-label">Firma Logosu</label>  
                <input class="form-control" type="file" id="companyLogo" name="companyLogo" required>  
            </div>  
