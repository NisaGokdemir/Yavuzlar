...
if (isset($_POST['foodName']) && isset($_POST['foodDesc']) && isset($_POST['foodPrice']) && isset($_POST['foodDiscount']) && isset($_POST['restaurantId']) && isset($_FILES['foodLogo']) && $_FILES['foodLogo']['error'] === UPLOAD_ERR_OK) {
        $foodName = $_POST['foodName'];  
        $foodDesc = $_POST['foodDesc'];  
        $foodPrice = $_POST['foodPrice'];  
        $foodDiscount = $_POST['foodDiscount'];
        $restaurantId = $_POST['restaurantId'];  
        $restaurantLogo = $_POST['foodLogo'];
        ...
        if(move_uploaded_file($fileTmpPath, $dest_path)) {  
            addFood($foodName, $foodDesc, $foodPrice, $foodDiscount, $restaurantId, $dest_path);  
            header("Location: companyFood.php?message=Yemek başarıyla eklendi!");  
            exit;  
        } else {  
