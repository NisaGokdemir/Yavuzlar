<?php
    ...
    $result = getCuponsWithoutRestaurant();
...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <form action="addRestaurantCuponQuery.php" method="POST" enctype="multipart/form-data">  
            ...
            <div class="mb-3">  
                <label for="cuponId" class="form-label">Kupon</label>  
                <select class="form-select" id="cuponId" name="cuponId" required>  
                    <option value="">Seçiniz</option>   
                    <?php foreach ($result as $cupon): ?>
                        <option value="<?php echo $cupon['id']; ?>"><?php echo $cupon['name']; ?></option>  
                    <?php endforeach; ?>  
                </select>  
            </div>
