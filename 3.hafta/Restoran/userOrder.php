<?php
    ...
    $userId = $_SESSION['id'];
    $result = getActiveOrders($userId);

    if (isset($_POST['show_past'])) {
        $result = getPastOrders($userId);
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <h5 class="title mb-4">Siparişlerim</h5>
        <div class="d-grid gap-2 d-md-block mb-3">
            <form method="POST" action="">
                <button class="btn btn-primary" type="submit" name="show_past">Geçmiş Görüntüle</button>
            </form>
        </div>
        <?php foreach ($result as $order): ?>
            <div class="card mb-4" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p>Yemekler: <?php echo $order['food_name']; ?></p>
                </div>
            </div>
        <?php endforeach; ?>
