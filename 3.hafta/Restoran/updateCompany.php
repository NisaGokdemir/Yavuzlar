...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="container" style="margin-top: 100px;">
        <form action="updateCompanyQuery.php" method="POST" enctype="multipart/form-data">  
            <h5 class="title mb-4 mt-5">Firma Güncelle</h5>
            <div class="mb-3">  
                <input type="hidden" name="id" value="<?php echo $company['id']; ?>"> 
                <label for="companyName" class="form-label">Firma Adı</label>  
                <input type="text" class="form-control" id="companyName" name="companyName" required value="<?php echo $company['name']; ?>">  
            </div>  
            <div class="mb-3">  
                <label for="companyDesc" class="form-label">Açıklama</label>  
                <textarea class="form-control" id="companyDesc" name="companyDesc" rows="3" required><?php echo $company['description']; ?></textarea>  
            </div>  
            <div class="mb-3">  
