...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <h5 class="title mb-4 mt-5">Kuponlar</h5>
        ...
        <form action="addBasketQuery.php" method="POST" enctype="multipart/form-data">  
            <h5 class="title mb-4 mt-5">Sepete Ekle</h5>
            <div class="mb-3">  
            ...
            <div class="mb-3">  
                ...
                <input type="text" class="form-control" id="quantıty" name="quantity" required>  
            </div>  
